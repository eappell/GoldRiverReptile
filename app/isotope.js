        ...
        for(var i = 0; i < items.length; i++){
            ...
            switch(type.value){
                ...
                case "adult":
                    ...
                    if(moment().diff(dob,'years') > 3)
                        filtered.push(item);
                    break;
                case "baby":
                    var dob = moment(item.dob);
                    if(moment().diff(dob,'years') < 2)
                        filtered.push(item);
                    break;
                case "gtp":
                    if(item.species === 'Green Tree Python')
                        filtered.push(item);
                    break;
                case "otherSnake":
                    if(item.species != 'Green Tree Python' && item.species != 'Crested Gecko')
                        filtered.push(item);
                    break;
                case "crested":
                    if(item.species === 'Crested Gecko')
                        filtered.push(item);
                    break;
            }
        }
...
var collection = [
    ...
    },
    {
        ...
        photos: [
            {filename: 'Chinacat/006', caption: ''},
            {filename: 'Chinacat/005', caption: ''},
            {filename: 'Chinacat/003', caption: ''},
            {filename: 'Chinacat/004', caption: ''},
        ],
        speciesLatin: 'Morelia Viridis',
        species: 'Green Tree Python',
        sex: 'female',
    ...
    },
    {
        ...
        name: 'DynamoHum',
        photos: [
            {filename: 'DynamoHum/001', caption: '001'},
            {filename: 'DynamoHum/002', caption: '002'},
            {filename: 'DynamoHum/003', caption: '003'},
            {filename: 'DynamoHum/004', caption: '004'},
    ...
    },
    {
        ...
        description: 'This was a joint pairing with Randall Pearson and Vita Cernoch. Pairing Rhea An Arubiak, and his Calico/Jayapura male Baldur.'
    },
    {
        id: 'SH08146',
        name: 'Ziggy',
    ...
    },
    {
        ...
        photos: [
            ...
            {filename: 'GRR2015/GRR1503b', caption: ''},
            {filename: 'GRR2015/GRR1503c', caption: ''}
        ],
        speciesLatin: 'Morelia Viridis',
        species: 'Green Tree Python',
        sex: 'unknown',
    ...
    },
    {
        ...
        hatchColor: 'red',
        dateAdded: '2015-01-19',
        description: 'Ella x Dupree neonate - having a hard time getting this one started.  Very stubborn eater.  Hoping I can get it on pinkies soon...',
        productOfProject: 'GRR2015-1'
    },
    {
        id: 'GRR1512',
